...
// Eeliminar comentario o respuesta solo si sos el autor
...
//       if (c.id === idNum && c.user === user.username) {
//         eliminado = true;
//         return false;
//       }
...
//       c.respuestas = c.respuestas.filter(r => !(r.id === idNum && r.user === user.username));
//       if (c.respuestas.length < antes) eliminado = true;
